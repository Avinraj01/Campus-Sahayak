...
This guide explains how to deploy the Campus Management System to Render.
...
|----------|-------------|---------------|
| `CORS_ORIGINS` | Comma-separated list of allowed frontend origins | `https://your-frontend-domain.onrender.com` |
...
3. Add your Render service IP to the IP whitelist (or use 0.0.0.0/0 for testing)
4. Get the connection string and set it as `MONGO_URL` in Render
...
Render will automatically use this to check service health.
...
4. **Startup Failures**: Check logs in Render dashboard for error messages
...
1. Upgrading to a paid Render instance for better performance
